 ...
 * @return {*}
 */
export const cesiumFireworks = (viewer:any)=> {
...
function createFirework(offset: Cesium.Cartesian3, color: Cesium.Color, bursts: Cesium.ParticleBurst[]) {
    ...
    const force = function (particle: { position: Cesium.Cartesian3; velocity: Cesium.Cartesian3 | undefined; }) {
