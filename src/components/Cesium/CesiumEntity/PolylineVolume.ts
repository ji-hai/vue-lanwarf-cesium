...
class PolylineVolumeEntity extends EntityMethods{
	declare viewer: any
	...
	constructor(options: { viewer: any; geojsonData: { features: { geometry: { coordinates: number[][][]; type: string }; type: string; properties: {} }[]; type: string }; config: {} }) {
		super()
...
export default PolylineVolumeEntity
